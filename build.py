...
"""
    ...
    for i in lists:
        ...
        if os.path.isdir(f"{path}/{i}"):
            htmlstring += f'\n          <li><a href="{i}"><img src="/ico/folder.svg" width=20px style="width=20px;vertical-align:middle;">  {i}/</a></li>'
        else:
            if ".deb" == os.path.splitext(i)[1]:
                htmlstring += f'\n          <li><a href="{i}"><img src="/ico/deb.svg" width=20px style="width=20px;vertical-align:middle;">  {i}</a></li>'
            elif ".jpg" == os.path.splitext(i)[1]:
                htmlstring += f'\n          <li><a href="{i}"><img src="/ico/image-jpeg.svg" width=20px style="width=20px;vertical-align:middle;">  {i}</a></li>'
            else:
                htmlstring += f'\n          <li><a href="{i}"><img src="/ico/text-x-source.svg" width=20px style="width=20px;vertical-align:middle;">  {i}</a></li>'
    htmlstring += f"""     </ul>
        <hr/>
